...
class CleansersSpider(scrapy.Spider):
    ...
    def start_requests(self):
        search_url = 'https://www.dermstore.com/skin-care/treatments-serums.list?pageNumber=1'
    ...
    def parse(self, response):
        ...
        if page_num < total_pages:
            page_num += 1
            next_page = 'https://www.dermstore.com/skin-care/treatments-serums.list?pageNumber='+str(page_num)
